             ...
             if (blueData.bleDataType == BLEMIND) {
                 ...
                 if (blueData.HRV != nil) {
                     for (int i = 0; i < blueData.HRV.count; i++) {
                         if(i >= 1){
                             hrvStr = [hrvStr stringByAppendingString:[NSString stringWithFormat:@",%dms",[blueData.HRV[i] intValue]]];
                         }else{
                             hrvStr = [hrvStr stringByAppendingString:[NSString stringWithFormat:@"%dms",[blueData.HRV[i] intValue]]];
                         }
                     }
